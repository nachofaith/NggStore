                ...
                shippingData.map((item) => (
                  <li key={item.id}>
                    <input
                      ...
                      checked={shippingInfo?.id === item.id} // Verifica si esta opción es la seleccionada
                    />
                    <label
                    ...
                    >
                      ...
                      <span className="uppercase">
                        {item.type === "Envío por pagar" && `Por Pagar`}
                        {item.price === 0 &&
                          item.type !== "Envío por pagar" &&
                          "GRATIS"}
                        {item.price > 0 && <FormatCLP precio={item.price} />}
                      </span>
                    </label>
                  </li>
                ))}
