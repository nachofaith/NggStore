...
export function Products(props) {
  ...
  return (
    ...
    <div class="text-center max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 pt-2">
      {tipo === "news" && (
        <div>
          <span class="bg-green-600 text-white text-xs font-semibold me-2 px-2.5 py-0.5 rounded-full dark:bg-yellow-900 dark:text-yellow-300">
            Nuevo
      ...
      <div class="p-5 flex flex-col">
        ...
        <p class="mb-3 text-xl font-normal text-gray-700 dark:text-gray-400 p-4">
          $194.990
        </p>
        <div>
        <a
