...
export function Products(props) {
  ...
  return (
    <div className="hover:shadow-blue-500/50 hover:shadow-xl text-center flex flex-col align-middle max-w-sm border rounded-lg shadow pt-2">
      <Link to={`/producto/${idProd}`} className="flex flex-col h-full">
        {tipo === "news" && (
          <div>
